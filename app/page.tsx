    ...
    <div className="md:flex flex-col md:m-0 md:m-5 md:w-screen m-6">
      ...
      <div className="md:w-[1000px] mx-auto">
        ...
        <div className="md:*:my-5 *:my-4 mx-auto md:text-lg text-[1rem] md:font-light font-normal md:mt-10 *:break-normal" style={inter.style}>
          <p l>O-DB Studio ("the Studio") of Perth, WA, is a internet design and technology studio building products for businesses and teams. We specialise in coding, desing, branding, and marketing. We are dedicated to helping you develop, launch, and manage your projects.</p>
